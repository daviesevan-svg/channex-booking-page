...
export default [
  ...
  route("v1/manage/rooms/:id", "routes/api.v1.manage.rooms.$id.tsx"),
  route("v1/manage/rates", "routes/api.v1.manage.rates.tsx"),
  route("v1/manage/rates/:id", "routes/api.v1.manage.rates.$id.tsx"),
  route("v1/manage/taxes", "routes/api.v1.manage.taxes.tsx"),
  route("v1/manage/extras", "routes/api.v1.manage.extras.tsx"),
  route("v1/manage/extras/:id", "routes/api.v1.manage.extras.$id.tsx"),
  ...
  route("v1/manage/site/pages/:id/sections", "routes/api.v1.manage.site.pages.$id.sections.tsx"),
  route("v1/manage/site/pages/:id/copy", "routes/api.v1.manage.site.pages.$id.copy.tsx"),
  route("v1/manage/site/footer", "routes/api.v1.manage.site.footer.tsx"),
  route("v1/manage/gallery", "routes/api.v1.manage.gallery.tsx"),
  route("v1/manage/gallery/text", "routes/api.v1.manage.gallery.text.tsx"),
  ...
  route("v1/manage/voucher-products", "routes/api.v1.manage.voucher-products.tsx"),
  route("v1/manage/voucher-products/:id", "routes/api.v1.manage.voucher-products.$id.tsx"),
  route("v1/manage/brand", "routes/api.v1.manage.brand.tsx"),
  route("v1/manage/brand-kit", "routes/api.v1.manage.brand-kit.tsx"),
  route("v1/manage/reviews", "routes/api.v1.manage.reviews.tsx"),
  route("v1/manage/reviews/:id/response", "routes/api.v1.manage.reviews.$id.response.tsx"),
  route("v1/manage/team", "routes/api.v1.manage.team.tsx"),
  route("v1/manage/team/:id", "routes/api.v1.manage.team.$id.tsx"),
  route("v1/manage/webhooks", "routes/api.v1.manage.webhooks.tsx"),
  route("v1/manage/webhooks/:id", "routes/api.v1.manage.webhooks.$id.tsx"),
  route("v1/manage/google", "routes/api.v1.manage.google.tsx"),
